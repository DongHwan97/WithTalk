...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "chat4.db";
    ...
    public DataBaseHelper(Context context) {
        ...
        //DB_PATH = mContext.getExternalFilesDir(Environment.DIRECTORY_PICTURES) + "/";
        DB_PATH = mContext.getDataDir().getAbsolutePath() + "/databases/";
    }
